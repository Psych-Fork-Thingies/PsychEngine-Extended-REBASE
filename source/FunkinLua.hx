...
class HScript
{
	...
	public function new()
	{
		...
		interp.variables.set('Memory', flixel.util.FlxStringUtil.formatBytes(memoryMegas)); //For Lua
		interp.variables.set('FPS',  backend.FPSCounter.currentFPSLua); //For Lua
